...
const CONSTRAINT_ENFORCEMENT_INTERVAL = (15 * 1000);
const NODE_LIVELINESS_INTERVAL = (60 * 1000);

class K8SHost extends HostImplementation {
    constructor(host_id, cluster_id, mode, api_ip, api_port, k8s_api_ip, k8s_api_port, preferred_nic, flannel_interface = 'flannel0', flannel_backend_port = '8285') {
        ...
        this.flannel_interface = flannel_interface;
        this.flannel_backend_port = flannel_backend_port;
    ...
    getFlannelInterface() {
        return this.flannel_interface;
    }

    getFlannelBackendPort() {
        return this.flannel_backend_port;
    }
